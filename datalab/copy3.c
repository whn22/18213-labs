...
int floatIsLess(unsigned uf, unsigned ug) {
    ...
    unsigned sign1 = uf & sMask;
    unsigned sign2 = ug & sMask;

    unsigned exp1 = uf & eMask;
    unsigned exp2 = ug & eMask;

    unsigned frac1 = uf & fMask;
    unsigned frac2 = ug & fMask;

    if ((exp1 == eMask && frac1 != 0) | (exp2 == eMask && frac2 != 0)) {
        return 0;
    }
    if ((uf << 1) == 0 && (ug << 1) == 0) {
        return 0;
